...
def scrape (global_data=None,query="long bob hairstyle", folder=RAW_IMAGES_DIR , download_callback=None, finished_callback=None, hide_browser=HIDE_BROWSER):
    ...
    image_scraper.find_image_urls(global_data)
